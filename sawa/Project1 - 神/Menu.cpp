...
void Menu_Draw() {
	...
	int PL1 = LoadGraph("画像/PLAYER1.png"); int PL2 = LoadGraph("画像/PLAYER2.png");
	int PL1UP = LoadGraph("画像/1UP.png");  int PL2UP = LoadGraph("画像/2UP.png");
	int HISCORE = LoadGraph("画像/HISCORE.png");
	int NAMUCO = LoadGraph("画像/NAMUCO.png");
